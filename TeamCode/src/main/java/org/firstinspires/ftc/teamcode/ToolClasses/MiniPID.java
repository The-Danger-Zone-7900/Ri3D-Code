...
public class MiniPID{
	 ...
	 * <pre>output*(1-strength)*sum(0..n){output*strength^n}</pre> algorithmalid between [0..1), meaning [current output only.. historical output only)
	 */
